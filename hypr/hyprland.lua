...
hl.config({
	general = {
		...
		border_size = 1,
		col = {
			active_border = { colors = { "rgba(00ffffaa)", "rgba(ff00ffaa)" }, angle = 89 },
...
hl.animation({ leaf = "global", enabled = true, speed = 1.333, bezier = "linear" })
hl.animation({ leaf = "windows", enabled = true, speed = 1.333, bezier = "linear", style = "popin 89%" })
hl.animation({ leaf = "workspaces", enabled = true, speed = 1.0, bezier = "linear", style = "fade" })
